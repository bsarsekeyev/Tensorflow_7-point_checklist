...
category_path = src_path +"images_category3/"
...
meta_train = meta_train[['case_num','pigmentation','derm']]
meta_train.loc[meta_train['pigmentation']=='absent','pigmentation'] = int(0)
meta_train.loc[meta_train['pigmentation']=='diffuse irregular','pigmentation'] = int(1)
meta_train.loc[meta_train['pigmentation']=='diffuse regular','pigmentation'] = int(1)
meta_train.loc[meta_train['pigmentation']=='localized regular','pigmentation'] = int(1)
meta_train.loc[meta_train['pigmentation']=='localized irregular','pigmentation'] = int(1)

meta_val = meta_val[['case_num','pigmentation','derm']]
meta_val.loc[meta_val['pigmentation']=='absent','pigmentation'] = int(0)
meta_val.loc[meta_val['pigmentation']=='diffuse irregular','pigmentation'] = int(1)
meta_val.loc[meta_val['pigmentation']=='diffuse regular','pigmentation'] = int(1)
meta_val.loc[meta_val['pigmentation']=='localized regular','pigmentation'] = int(1)
meta_val.loc[meta_val['pigmentation']=='localized irregular','pigmentation'] = int(1)

meta_test = meta_test[['case_num','pigmentation','derm']]
meta_test.loc[meta_test['pigmentation']=='absent','pigmentation'] = int(0)
meta_test.loc[meta_test['pigmentation']=='diffuse irregular','pigmentation'] = int(1)
meta_test.loc[meta_test['pigmentation']=='diffuse regular','pigmentation'] = int(1)
meta_test.loc[meta_test['pigmentation']=='localized regular','pigmentation'] = int(1)
meta_test.loc[meta_test['pigmentation']=='localized irregular','pigmentation'] = int(1)
