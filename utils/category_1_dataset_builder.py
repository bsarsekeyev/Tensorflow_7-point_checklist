...
category_path = src_path +"images_category1/"
...
meta_train = meta_train[['case_num','pigment_network','derm']]
meta_train.loc[meta_train['pigment_network']=='absent','pigment_network'] = int(0)
meta_train.loc[meta_train['pigment_network']=='typical','pigment_network'] = int(1)
meta_train.loc[meta_train['pigment_network']=='atypical','pigment_network'] = int(1)

meta_val = meta_val[['case_num','pigment_network','derm']]
meta_val.loc[meta_val['pigment_network']=='absent','pigment_network'] = int(0)
meta_val.loc[meta_val['pigment_network']=='typical','pigment_network'] = int(1)
meta_val.loc[meta_val['pigment_network']=='atypical','pigment_network'] = int(1)

meta_test = meta_test[['case_num','pigment_network','derm']]
meta_test.loc[meta_test['pigment_network']=='absent','pigment_network'] = int(0)
meta_test.loc[meta_test['pigment_network']=='typical','pigment_network'] = int(1)
meta_test.loc[meta_test['pigment_network']=='atypical','pigment_network'] = int(1)
