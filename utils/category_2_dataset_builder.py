...
category_path = src_path +"images_category2/"
...
meta_train = meta_train[['case_num','streaks','derm']]
meta_train.loc[meta_train['streaks']=='absent','streaks'] = int(0)
meta_train.loc[meta_train['streaks']=='regular','streaks'] = int(1)
meta_train.loc[meta_train['streaks']=='irregular','streaks'] = int(1)

meta_val = meta_val[['case_num','streaks','derm']]
meta_val.loc[meta_val['streaks']=='absent','streaks'] = int(0)
meta_val.loc[meta_val['streaks']=='regular','streaks'] = int(1)
meta_val.loc[meta_val['streaks']=='irregular','streaks'] = int(1)

meta_test = meta_test[['case_num','streaks','derm']]
meta_test.loc[meta_test['streaks']=='absent','streaks'] = int(0)
meta_test.loc[meta_test['streaks']=='regular','streaks'] = int(1)
meta_test.loc[meta_test['streaks']=='irregular','streaks'] = int(1)
