...
category_path = src_path +"images_category5/"
...
meta_train = meta_train[['case_num','dots_and_globules','derm']]
meta_train.loc[meta_train['dots_and_globules']=='absent','dots_and_globules'] = int(0)
meta_train.loc[meta_train['dots_and_globules']=='regular','dots_and_globules'] = int(1)
meta_train.loc[meta_train['dots_and_globules']=='irregular','dots_and_globules'] = int(1)

meta_val = meta_val[['case_num','dots_and_globules','derm']]
meta_val.loc[meta_val['dots_and_globules']=='absent','dots_and_globules'] = int(0)
meta_val.loc[meta_val['dots_and_globules']=='regular','dots_and_globules'] = int(1)
meta_val.loc[meta_val['dots_and_globules']=='irregular','dots_and_globules'] = int(1)

meta_test = meta_test[['case_num','dots_and_globules','derm']]
meta_test.loc[meta_test['dots_and_globules']=='absent','dots_and_globules'] = int(0)
meta_test.loc[meta_test['dots_and_globules']=='regular','dots_and_globules'] = int(1)
meta_test.loc[meta_test['dots_and_globules']=='irregular','dots_and_globules'] = int(1)
