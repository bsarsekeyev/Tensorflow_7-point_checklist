...
category_path = src_path +"images_category4/"
...
meta_train = meta_train[['case_num','regression_structures','derm']]
meta_train.loc[meta_train['regression_structures']=='absent','regression_structures'] = int(0)
meta_train.loc[meta_train['regression_structures']=='blue areas','regression_structures'] = int(1)
meta_train.loc[meta_train['regression_structures']=='combinations','regression_structures'] = int(1)
meta_train.loc[meta_train['regression_structures']=='white areas','regression_structures'] = int(1)

meta_val = meta_val[['case_num','regression_structures','derm']]
meta_val.loc[meta_val['regression_structures']=='absent','regression_structures'] = int(0)
meta_val.loc[meta_val['regression_structures']=='blue areas','regression_structures'] = int(1)
meta_val.loc[meta_val['regression_structures']=='combinations','regression_structures'] = int(1)
meta_val.loc[meta_val['regression_structures']=='white areas','regression_structures'] = int(1)

meta_test = meta_test[['case_num','regression_structures','derm']]
meta_test.loc[meta_test['regression_structures']=='absent','regression_structures'] = int(0)
meta_test.loc[meta_test['regression_structures']=='blue areas','regression_structures'] = int(1)
meta_test.loc[meta_test['regression_structures']=='combinations','regression_structures'] = int(1)
meta_test.loc[meta_test['regression_structures']=='white areas','regression_structures'] = int(1)
